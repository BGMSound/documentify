...
import io.github.bgmsound.documentify.core.specification.element.field.ARRAY
import io.github.bgmsound.documentify.core.specification.element.field.Field
import io.github.bgmsound.documentify.core.specification.element.field.OBJECT

abstract class BodySpec(
    protected val fields: MutableList<Field> = mutableListOf()
) : DocumentableSpec, FieldSchema {
